...
export default function Navbar() {
  ...
  const renderHr = (linkName) => {
    return activeLink === linkName ? <hr className="my-2 border-gray-200" /> : null;
  };
                    ...
                    {navigation.map((item) => (
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current === activeLink ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                  ...
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg?size=626&ext=jpg&ga=GA1.1.1163074268.1706465765&semt=sph"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.name === activeLink ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                    'block rounded-md px-3 py-2 text-base font-medium sm:mr-4'
                  )}
                  aria-current={item.current ? 'page' : undefined}
                  onClick={() => handleLinkClick(item.name)}
                >
